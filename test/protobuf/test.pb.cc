...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::MyRPC::ResultCode, _impl_.errcode_),
  PROTOBUF_FIELD_OFFSET(::MyRPC::ResultCode, _impl_.errmsg_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::MyRPC::LoginRequest, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::MyRPC::LoginRequest, _impl_.pwd_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::MyRPC::LoginResponse, _impl_.result_),
  PROTOBUF_FIELD_OFFSET(::MyRPC::LoginResponse, _impl_.success_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::MyRPC::GetFriendListRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::MyRPC::GetFriendListRequest, _impl_.userid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::MyRPC::User, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::MyRPC::User, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::MyRPC::User, _impl_.age_),
  PROTOBUF_FIELD_OFFSET(::MyRPC::User, _impl_.sex_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::MyRPC::GetFriendListResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::MyRPC::GetFriendListResponse, _impl_.result_),
  PROTOBUF_FIELD_OFFSET(::MyRPC::GetFriendListResponse, _impl_.friend_list_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::MyRPC::ResultCode)},
  { 8, -1, -1, sizeof(::MyRPC::LoginRequest)},
  { 16, -1, -1, sizeof(::MyRPC::LoginResponse)},
  { 24, -1, -1, sizeof(::MyRPC::GetFriendListRequest)},
  { 31, -1, -1, sizeof(::MyRPC::User)},
  { 40, -1, -1, sizeof(::MyRPC::GetFriendListResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::MyRPC::_ResultCode_default_instance_._instance,
  &::MyRPC::_LoginRequest_default_instance_._instance,
  &::MyRPC::_LoginResponse_default_instance_._instance,
  &::MyRPC::_GetFriendListRequest_default_instance_._instance,
  &::MyRPC::_User_default_instance_._instance,
  &::MyRPC::_GetFriendListResponse_default_instance_._instance,
};

const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\ntest.proto\022\005MyRPC\"-\n\nResultCode\022\017\n\007err"
  ...
  "\022\013\n\003age\030\002 \001(\r\022\034\n\003sex\030\003 \001(\0162\017.MyRPC.User."
  "Sex\"\031\n\003Sex\022\007\n\003MAN\020\000\022\t\n\005WOMAN\020\001\"\\\n\025GetFri"
  "endListResponse\022!\n\006result\030\001 \001(\0132\021.MyRPC."
  "ResultCode\022 \n\013friend_list\030\002 \003(\0132\013.MyRPC."
  "User2\221\001\n\016UserServiceRpc\0222\n\005Login\022\023.MyRPC"
  ".LoginRequest\032\024.MyRPC.LoginResponse\022K\n\016G"
  "etFriendLists\022\033.MyRPC.GetFriendListReque"
  "st\032\034.MyRPC.GetFriendListResponseB\003\200\001\001b\006p"
  "roto3"
  ;
static ::_pbi::once_flag descriptor_table_test_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 565, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
ResultCode::ResultCode(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:MyRPC.ResultCode)
}
...
LoginRequest::LoginRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:MyRPC.LoginRequest)
}
...
LoginResponse::LoginResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:MyRPC.LoginResponse)
}
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_result()) {
    _this->_impl_.result_ = new ::MyRPC::ResultCode(*from._impl_.result_);
  }
...
void LoginResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_result()) {
    _this->_internal_mutable_result()->::MyRPC::ResultCode::MergeFrom(
...
GetFriendListRequest::GetFriendListRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:MyRPC.GetFriendListRequest)
}
GetFriendListRequest::GetFriendListRequest(const GetFriendListRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:MyRPC.GetFriendListRequest)
}
...
GetFriendListRequest::~GetFriendListRequest() {
  // @@protoc_insertion_point(destructor:MyRPC.GetFriendListRequest)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:MyRPC.GetFriendListRequest)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* GetFriendListRequest::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:MyRPC.GetFriendListRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MyRPC.GetFriendListRequest)
  return target;
}

size_t GetFriendListRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:MyRPC.GetFriendListRequest)
  size_t total_size = 0;
...
void GetFriendListRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:MyRPC.GetFriendListRequest)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:MyRPC.GetFriendListRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
User::User(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:MyRPC.User)
}
User::User(const User& from)
  ...
  // @@protoc_insertion_point(copy_constructor:MyRPC.User)
}
...
User::~User() {
  // @@protoc_insertion_point(destructor:MyRPC.User)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
void User::Clear() {
// @@protoc_insertion_point(message_clear_start:MyRPC.User)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          goto handle_unusual;
        continue;
      // .MyRPC.User.Sex sex = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_sex(static_cast<::MyRPC::User_Sex>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* User::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:MyRPC.User)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MyRPC.User)
  return target;
}

size_t User::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:MyRPC.User)
  size_t total_size = 0;
...
void User::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:MyRPC.User)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:MyRPC.User)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class GetFriendListResponse::_Internal {
 public:
  static const ::MyRPC::ResultCode& result(const GetFriendListResponse* msg);
};
...
GetFriendListResponse::GetFriendListResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:MyRPC.GetFriendListResponse)
}
GetFriendListResponse::GetFriendListResponse(const GetFriendListResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:MyRPC.GetFriendListResponse)
}
...
GetFriendListResponse::~GetFriendListResponse() {
  // @@protoc_insertion_point(destructor:MyRPC.GetFriendListResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:MyRPC.GetFriendListResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          goto handle_unusual;
        continue;
      // repeated .MyRPC.User friend_list = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ptr -= 1;
          do {
...
uint8_t* GetFriendListResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:MyRPC.GetFriendListResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MyRPC.GetFriendListResponse)
  return target;
}

size_t GetFriendListResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:MyRPC.GetFriendListResponse)
  size_t total_size = 0;
...
void GetFriendListResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:MyRPC.GetFriendListResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:MyRPC.GetFriendListResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void UserServiceRpc::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::MyRPC::GetFriendListRequest*,
                         ::MyRPC::GetFriendListResponse*,
                         ::google::protobuf::Closure* done) {
  ...
  switch(method->index()) {
    ...
    case 1:
      GetFriendLists(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::MyRPC::GetFriendListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::MyRPC::GetFriendListResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::MyRPC::GetFriendListRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::MyRPC::GetFriendListResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void UserServiceRpc_Stub::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                              const ::MyRPC::GetFriendListRequest* request,
                              ::MyRPC::GetFriendListResponse* response,
                              ::google::protobuf::Closure* done) {
...
template<> PROTOBUF_NOINLINE ::MyRPC::ResultCode*
Arena::CreateMaybeMessage< ::MyRPC::ResultCode >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyRPC::ResultCode >(arena);
}
template<> PROTOBUF_NOINLINE ::MyRPC::LoginRequest*
Arena::CreateMaybeMessage< ::MyRPC::LoginRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyRPC::LoginRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::MyRPC::LoginResponse*
Arena::CreateMaybeMessage< ::MyRPC::LoginResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyRPC::LoginResponse >(arena);
}
template<> PROTOBUF_NOINLINE ::MyRPC::GetFriendListRequest*
Arena::CreateMaybeMessage< ::MyRPC::GetFriendListRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyRPC::GetFriendListRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::MyRPC::User*
Arena::CreateMaybeMessage< ::MyRPC::User >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyRPC::User >(arena);
}
template<> PROTOBUF_NOINLINE ::MyRPC::GetFriendListResponse*
Arena::CreateMaybeMessage< ::MyRPC::GetFriendListResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyRPC::GetFriendListResponse >(arena);
}
