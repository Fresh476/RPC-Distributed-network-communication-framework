...
inline void GetFriendsListResponse::unsafe_arena_set_allocated_result(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:MyRPC.GetFriendsListResponse.result)
}
...
inline ::MyRPC::ResultCode* GetFriendsListResponse::unsafe_arena_release_result() {
